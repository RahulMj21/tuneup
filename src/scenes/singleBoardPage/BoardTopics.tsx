        ...
        >
            ...
            {BOARD_TOPICS.map(({ text, topic }) => (
                <Button
                    ...
                    className={cn(
                        "relative px-3 tracking-wide text-gray-1 hover:text-light-2 before:absolute before:w-4/5 before:-bottom-[0.75rem] before:h-[2.3px] before:rounded-full before:hidden before:bg-light-2 before:-translate-x-1/2 before:left-1/2 before:pointer-events-none transition-all",
