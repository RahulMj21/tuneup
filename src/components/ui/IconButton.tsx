...
const buttonVariants = cva(
    "relative flex items-center justify-center cursor-pointer p-2 rounded-full transition-all",
    {
        variants: {
            variant: {
                default: "hover:bg-gray-600/20 active:bg-gray-600/30",
                outlined:
                    "border border-gray-5 hover:bg-gray-600/30 active:bg-gray-600/40",
